...
class PartnerXlsx(models.AbstractModel):
        ...
        _template = {
            'name': {
                ...
                'data': {
                    ...
                    'format': FORMATS['format_date_left'],
    ...
    def generate_report(self, workbook, ws, ws_params, data, run_ids):
        ...
        for line in adjustment_ids:
            ...
            price_total = (po_line.qty_received * po_line.price_subtotal) / po_line.product_qty
            ...
            datos.setdefault(line.move_id.id, {}).update({
                ...
                'price_total': price_total,  # line.move_id.purchase_line_id.price_subtotal,#price_unit * line.quantity,
